...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        module.aqiText[aqi].message
             ...
             <div class="card card-sm highlight-card two">
                ...
                <div class="card-list">
                    ...
                    <div class="card-item">
                        <span class="m-icon">wb_twilight</span>
                        <div>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
                 <div class="card card-sm slider-card">
                  ...
                  <img src="assets/img-weather/${icon}.png" width="48" height="48" loading="lazy" alt="${description}"
        ...
        windLi.innerHTML = `
                 <div class="card card-sm slider-card">
                    ...
                    <img src="assets/img-weather/direction.png" width="48" height="48" loading="lazy" alt="direction"
      ...
      forecastSection.innerHTML = `
                <h2 class="title-2" id="forecast-label"></h2>
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
                  <div class="icon-wrapper">
                     <img src="assets/img-weather/${icon}.png" width="36" height="36" alt="${description}"
                        class="weather-icon" title="${description}">
